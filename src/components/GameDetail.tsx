      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
                ...
                >
                  ...
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() => handleTogglePayment(player.id!)}
                      className="w-5 h-5"
                    />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setGameData({ ...gameData, startTime: e.target.value })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setGameData({ ...gameData, endTime: e.target.value })
              }
              className="border p-2 rounded-md w-full"
            />
          </div>
        ...
        <div className="mt-6">
          ...
          <input
            ...
            onChange={(e) =>
              setGameData({ ...gameData, gameFee: Number(e.target.value) })
            }
            min="0"
            className="border p-2 rounded-md w-full"
          />
        ...
        <div className="flex justify-between mt-6">
          ...
          >
            {deleteMutation.isPending ? "Removendo..." : "Excluir Jogo"}
          </button>
