...
export function PlayerCard({ player, index }: PlayerCardProps) {
    return (
        <Card className="border-primary flex w-full flex-col items-center gap-4 p-4 transition-shadow hover:shadow-lg md:flex-row md:justify-between">
            ...
            {/* Bloco da direita: badge e botão */}
            <div className="flex w-full flex-col items-center gap-3 md:w-auto md:flex-row md:justify-end">
                <Badge
                    className={cn(
